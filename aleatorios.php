<?
/********************************************************************
Nombre: aleatorios.php											     
Funcionalidad: Busca post en forma aleatoria 
...
//obtengo los post aleatorios
$dbarrPosts = $oPosts->getPost(0,0,1,1,$last);
?>
<!doctype html>
<html lang="es">
<head>
...
<? include("menu_princ.php")?>
	...
	<section id="main"><!-- #main content and sidebar area -->
			<section id="content"><!-- #content -->
				...
				<H3>VER POSTS ALEATORIAMENTE</H3>
 ...
 <br>
		<?}?>				
				...
				<div align="center">
					<form action="aleatorios.php">
						 <input type="hidden" name="last" value="<?=$dbarrPosts[0]['post_id']?>">
						 <input class="myButton" type="submit" name="i" value="VER PROXIMO POST">
						</form>
				</div>		
					<!--<a class="myButton" href="aleatorios.php?last=<?=$dbarrPosts[0]['post_id']?>"><b>VER PROXIMO POST</b></a>-->
					
					<br><br>
		
		<div class="fb-comments" data-href="http://www.todoscontentos.com?id=<?=$dbarrPosts[0]['post_id']?>" data-width="650" data-num-posts="10"></div>
