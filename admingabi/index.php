...
if ($_REQUEST['estado'] == 2) {
 ...
 { 
   ...
   $sResult = $oPosts->updPost($idpost, trim($_REQUEST['publicado']), trim($_REQUEST['titulo']), @$imgContent1, @$fileType, trim($_REQUEST['video']), trim($_REQUEST['descripcion']), $fecha_hoy, $_REQUEST['estado']);
...
$dbarrPosts = $oPosts->getPost(0,0,$pagina,0,0,0,1);
